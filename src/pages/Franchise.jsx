    ...
    <Testimonials senddata={testimonalsforfranchise} />
      <div className="franchisecompany">
        <div className="franchisecompany-part1-text mb-2">
          <p>Are you fascinated by the Kaffeehaus vibes? Do you want to build your own business?</p>
      ...
      <input type="file" id='file' style={{ display: 'none' }} ref={fileInputRef} />
    </form>
          </div>
          <div className="part2">
            ...
            <button><p>Send a request</p></button>
          </div>
        </div>
      </div>
      <Faq />
