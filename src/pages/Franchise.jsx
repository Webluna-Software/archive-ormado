...
const Franchise = () => {
  ...
  const [whyormado, setWhyOrmado] = useState([]);
  const [provide, setProvide] = useState([]);
  const [testimonial, setTestimonial] = useState([]);
  const [franchisecompany, setFranchiseCompany] = useState([]);
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      axios.get(`${ApiLink2}/franchiseForm`),
    ]).then(
      ([
        whyormado,
        provide,
        ...
        setLoading(false);
        setWhyOrmado(whyormado.data.data[0]);
        setProvide(provide.data.data[0]);
        setTestimonial(testimonial.data.data);
        setFranchiseCompany(franchisecompany.data.data);
        setFranchiseFaq(franchiseFaq.data.data);
        setFranchiseForm(franchiseform.data.data);
        console.log(franchiseFaq.data.data, "frafaq");
        console.log(testimonial.data.data, "test");
        console.log(provide.data.data, "pro");
      }
    );
  }, []);
    ...
    <div>
      <section className="franchise-mobile d-none">
        <div className="bg-clr">
          ...
          <p dangerouslySetInnerHTML={{ __html: whyormado.desc }}></p>
          <div className="ormado-button">
            <Link to="/franchiseform">
              <button className="ormado-button">INQUIRE NOW</button>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="franc-con">
          <div className="left">
            ...
            <div className="ormado-about">
              <p dangerouslySetInnerHTML={{ __html: whyormado.desc }}>
          ...
          <div className="right" onClick={() => {}}>
            <img className="img-fluid" src={whyormado.image} alt="" />
          </div>
        </div>
      ...
      <div className="franchisecompany">
        <div className="franchisecompany-part1-text mb-2">
          <p>
            Based on mutual agreement, we share and provide mentorship on all
            the necessary information required for a successful and risk-free
            start to the business. This includes interior design, furnishings,
            beverage and dessert menus, and more.
          </p>
          <h1>
            Franchise company <br /> <span>Ormado Kaffeehaus</span>
          </h1>
        </div>
        <div className="franchisecompany-card ">
          <div className="recommendations">
            ...
            <div className="recommendations-text">
              ...
              <p>
                We will be happy to consult you during discussion of your
                options. We will help you succeed by means of the area analysis,
                work aspects, and our experience.
              </p>
            </div>
          </div>
          <div className="part2">
          ...
          <div className="termConditions">
            ...
            <div className="termConditions-text">
              ...
              <ul>
                ...
                <li>
                  Investment up to 900 EUR per square meter (including VAT);
                </li>
        ...
        <div className="franchisecompany-btns">
          ...
          <div className="part2">
            <p>
              If you still haven&apos;t found answers to the questions that
              interest you, then fill out the forum and we will contact you!
            </p>
            <Link
              to="/franchiseform"
              onClick={() => {
