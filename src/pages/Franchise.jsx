   ...
   <Helmet>
    ...
    <section className="myfranchise">
      ...
      <div className="franc-con">
        ...
        <div className="right">
          <img className="img-fluid" src={why.image} alt="franchise image" />
        </div>
      </div>
      <div className="roasting">
        ...
        <div className="franchise-cards mb-5">
          ...
          <div className="row  franchise-image" >
            ...
            <img src={provide.image[2] ? provide.image[2] : ""} alt="franchiseImage" />
          </div>
          </LazyLoad>
        </div>
      </div>
      ...
      <div className="franchisecompany-card ">
        <div className="recommendations">
          ...
          <div className="recommendations-text">
            ...
            <p dangerouslySetInnerHTML={{__html:company.recommendText}}/>
          </div>
        </div>
        <div className="part2">
        ...
        <div className="termConditions"  onClick={handleRedirect}>
          ...
          <div className="termConditions-text">
            ...
            <p dangerouslySetInnerHTML={{__html:company.termandCon}}/>
          </div>
