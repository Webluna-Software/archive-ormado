              ...
              <div className="container-fluid">
                <div className="row justify-content-between">
                  ...
                  <div className="col-12 col-md-3">
                    <div
                      className={`d-flex ${window.location.pathname === "/account" ? "active" : ""
                        }`}
                      onClick={() => {
                    ...
                    <div
                      className={`d-flex ${window.location.pathname === "/order" ? "active" : ""
                        }`}
                      onClick={() => {
                    ...
                    <div
                      className={`d-flex ${window.location.pathname === "/address" ? "active" : ""
                        }`}
                      onClick={() => {
                    ...
                    <div
                      className={`d-flex ${window.location.pathname === "/password" ? "active" : ""
                        }`}
                      onClick={() => {
